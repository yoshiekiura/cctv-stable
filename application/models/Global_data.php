...
class Global_data extends CI_Model{
	...
	*/
		...
		$warna = [
			...
			2 => [
				...
				[
					...
					"testimoni"=>"linear-gradient( 109.5deg,  rgb(230, 126, 34) 11.2%, rgb(230, 126, 34) 91.1% )",
					"foot"=>"linear-gradient( 109.5deg,  rgb(230, 126, 34) 11.2%, rgb(230, 126, 34) 91.1% )",
					"foot_gradient"=>"linear-gradient( 109.5deg,  rgb(230, 126, 34) 11.2%, rgb(230, 126, 34) 91.1% )",
				],
			]
		];
	...
	// POINT WARGA
	function getPoint($id,$what,$opo="id",$mob=false){
		if($mob == false){
			$usrid = isset($_SESSION["usrid"]) ? $_SESSION["usrid"] : 0;
			$this->db->where("usrid",$usrid);
		}
