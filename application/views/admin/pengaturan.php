            ...
            <div class="col-md-3">
                <div class="dashboard-menu">
                    <ul class="nav flex-column" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" href="javascript:void(0)" data-link="#saldo"><span><i
                                        class="fas fa-wallet"></i>Saldo <?php echo $this->func->globalset("nama"); ?>
                                </span></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="javascript:void(0)" data-link="#rekening"><span><i
                                        class="fas fa-money-check"></i>Rekening</span></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="javascript:void(0)" data-link="#alamat"><span><i
                                        class="fas fa-map-marker-alt"></i>Alamat</span></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="javascript:void(0)" data-link="#informasi"><span><i
                                        class="fas fa-user"></i>Pegaturan Akun</span></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="javascript:void(0)" data-link="logout"
                                onclick="signoutNow()"><span><i class="fas fa-power-off"></i>Logout</span></a>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="col-md-9">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane in m-b-60" style="display:block;" id="saldo">
                        <div class="section row m-lr-0 m-b-40 p-tb-20 p-lr-20">
                            <div class="col-md-6 m-lr-auto">
                                <div class="p-tb-20">
                                    ...
                                    <div class="fs-24 font-bold text-primary">
                                        <?=strtoupper(strtolower($this->security->xss_clean($pro->nama)))?></div>
                                    <div class="fs-18 m-b-20">
                                        <div class="badge badge-success">
                                            <i class="fas fa-check-circle"></i>
                                            &nbsp;<?=$this->func->userlevel($usr->level)?>
                                        </div>
                                    </div>
                                    <div class="">
                                        Link Afiliasi:<br />
                                        <span
                                            class="text-dark font-medium"><?=site_url()."?aff=".$_SESSION["usrid"]?></span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 m-lr-auto">
                                <div class="p-tb-20">
                                    ...
                                    <div class="fs-28 font-bold text-success m-b-4"><b>Rp
                                            <?php echo $this->func->formUang($saldo->saldo); ?>,-</b></div>
                                    <div class="font-bold text-warning m-b-20">Koin &nbsp; <i class="fas fa-coins"></i>
                                        <b> <?php echo $this->func->formUang($saldo->koin); ?></b>
                                    </div>
                                    <div class="row">
                                        <div class="col-6">
                        ...
                        <div class="tab-pane in m-b-60" id="point">

                            <div class="section row m-lr-0 m-t-30 m-b-40 p-tb-20 p-lr-20">
                                <div class="col-md-8 m-lr-auto">
                                    <div class="p-tb-20">
                                        <h4 class="font-medium">Point Saat Ini</h4>
                                        <h2 class="font-bold text-success m-t-20">
                                            <b><?php echo $this->func->getPoint($_SESSION["usrid"],"point","usrid"); ?>
                                            </b>Point</h2>
                                    </div>
                                </div>
                                <div class="col-md-4 m-lr-auto">
                                    <div class="p-tb-20" style="margin-top: 1.4em">
                                        <a href="javascript:tukarPoint()"
                                            class="btn btn-success btn-lg btn-block m-b-10">
                                            <i class="fas fa-chevron-circle-up"></i>&nbsp; Tukar
                                        </a>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <form class="form-horizontal" id="profil">
                                        <div class="form-group m-b-12">
                                            ...
                                            <input class="form-control" type="text" name="nama"
                                                value="<?php echo $this->security->xss_clean($profil->nama); ?>">
                                        </div>
                                        <div class="form-group m-b-12">
                                            <label>Email</label>
                                            <input class="form-control" type="text" name="email"
                                                value="<?php echo $this->security->xss_clean($user->username); ?>">
                                        </div>
                                        <div class="form-group m-b-12">
                                            <label>No Whatsapp</label>
                                            <input class="form-control" type="text" name="nohp"
                                                value="<?php echo $this->security->xss_clean($profil->nohp); ?>">
                                        </div>
                                        <div class="form-group m-b-12">
                                            <label>Kelamin</label>
                                            <div class="rs1-select2 rs2-select2">
                                                <select class="js-select2 form-control" name="kelamin">
                                                    ...
                                                    <option value="1"
                                                        <?php if($profil->kelamin == 1){ echo "selected"; } ?>>Laki-laki
                                                    </option>
                                                    <option value="2"
                                                        <?php if($profil->kelamin == 2){ echo "selected"; } ?>>Perempuan
                                                    </option>
                                                </select>
                                        ...
                                        <div class="form-group m-t-50">
                                            <a href="javascript:void(0)" onclick="simpanProfil()"
                                                class="btn btn-success btn-block btn-lg">
                                                <i class="fas fa-check-circle"></i> &nbsp;Simpan Profil
                                            </a>
                                            <span id="profilload" style="display:none;"><i
                                                    class='fas fa-spin fa-compact-disc text-success'></i>
                                                Menyimpan...</span>
                                        </div>
                                    </form>
                                </div>
                                ...
                                <div class="section p-all-40 m-b-20">
                                    <form class="form-horizontal" id="gantipassword">
                                        ...
                                        <div class="form-group m-t-30">
                                            <a href="javascript:void(0)" onclick="simpanPassword()"
                                                class="btn btn-success btn-block btn-lg">
                                                <i class="fas fa-check-circle"></i> &nbsp;Simpan Password
                                            </a>
                                            <span id="passwload" style="display:none;"><i
                                                    class='fas fa-spin fa-compact-disc text-success'></i>
                                                Menyimpan...</span>
                                        </div>
                                    </form>
                        ...
                        <div class="section p-all-30 table-responsive">
                            <table class="table table-hover table-bordered table-striped">
                                ...
                                <tr class="table_row">
                                    ...
                                    <td>
                                        <a href="javascript:editRekening(<?php echo $res->id; ?>)"
                                            class="btn btn-success btn-sm" title="Edit"><i class="fas fa-edit"></i></a>
                                        <a href="javascript:hapusRekening(<?php echo $res->id; ?>)"
                        ...
                        <div class="section p-all-30 table-responsive">
                            <table class="table table-hover table-bordered table-striped">
                                ...
                                <tr class="table_row">
                                    ...
                                    <td>
                                        <p><?php echo $this->security->xss_clean($res->alamat)."<br/><small>Kodepos ".$this->security->xss_clean($res->kodepos)."</small>"; ?>
                                        </p>
                                    </td>
                                    <td>
                                        <a href="javascript:editAlamat(<?php echo $res->id; ?>)"
                                            class="btn btn-success btn-sm" title="Edit"><i class="fas fa-edit"></i></a>
                                        <a href="javascript:hapusAlamat(<?php echo $res->id; ?>)"
                                            class="btn btn-danger btn-sm" title="Hapus"><i
                                                class="fas fa-trash-alt"></i></a>
                                    </td>
                                </tr>
...
$(function() {
    ...
    $("#tariksaldo form").on("submit", function(e) {
        ...
        $(".submitbutton", this).parent().append(
            "<span class='cl1'><i class='fas fa-spin fa-compact-disc text-primary'></i> Memproses...</span>"
        );
        ...
        .then((willDelete) => {
            if (willDelete.isConfirmed) {
                $.post("<?php echo site_url("assync/bataltopup"); ?>", {
                    ...
                    if (data.success == true) {
                        swal.fire("Berhasil!", "Berhasil membatalkan topup saldo", "success").then((
                            value) => {
                            location.reload();
                        });
                    } else {
                ...
                <form method="POST" action="<?=site_url("manage/topupsaldo")?>">
                    <div class="col-md-12 p-b-30 m-t-30 p-lr-30">
                        <div class="form-group">
                            ...
                            <input class="form-control fs-20 font-medium" type="text" id="jumlahtopup" name="jumlah"
                                placeholder="Rp" required>
                        </div>
                        <div class="form-group row">
                            <div class="col-6 col-md-3 m-t-10">
                                <button type="button" class="btn btn-light btn-block"
                                    onclick="$('#jumlahtopup').val(50000)">50.000</button>
                            </div>
                            <div class="col-6 col-md-3 m-t-10">
                                <button type="button" class="btn btn-light btn-block"
                                    onclick="$('#jumlahtopup').val(100000)">100.000</button>
                            </div>
                            <div class="col-6 col-md-3 m-t-10">
                                <button type="button" class="btn btn-light btn-block"
                                    onclick="$('#jumlahtopup').val(150000)">150.000</button>
                            </div>
                            <div class="col-6 col-md-3 m-t-10">
                                <button type="button" class="btn btn-light btn-block"
                                    onclick="$('#jumlahtopup').val(200000)">200.000</button>
                            </div>
                        </div>
                ...
                <form class="form-horizontal">
                    ...
                    <div class="p-b-20 p-lr-30">
                        ...
                        <div class="m-b-12">
                            ...
                            <input class="form-control" id="rekeningnorek" type="text" name="norek" placeholder=""
                                required>
                        </div>
                        <div class="m-b-12">
                            <label>Atas Nama</label>
                            <input class="form-control" id="rekeningatasnama" type="text" name="atasnama" placeholder=""
                                required>
                        </div>
                        <div class="m-b-12">
                ...
                <form class="form-horizontal">
                    ...
                    <div class="p-b-15 p-lr-30">
                        <div class="m-b-12">
                            ...
                            <input class="form-control" id="alamatjudul" type="text" name="judul" placeholder=""
                                required>
                        </div>
                        <div class="m-b-12">
                        ...
                        <div class="m-b-12">
                            ...
                            <input class="form-control" id="alamatalamat" type="text" name="alamat" placeholder=""
                                required>
                        </div>
                        <div class="m-b-12">
                        ...
                        <div class="m-b-12">
                            <label>Kodepos</label>
                            <input class="form-control" id="alamatkodepos" type="text" name="kodepos" placeholder=""
                                required>
                        </div>
                        <div class="m-b-12">
