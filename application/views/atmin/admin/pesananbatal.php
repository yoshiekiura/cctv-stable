<div class="table-responsive">
    <table class="table table-condensed table-hover">
		...
		?>
        <tr>
            <td class="text-center"><i class="fas fa-times-circle text-danger"></i> &nbsp;
                <?=$this->admfunc->ubahTgl("d M Y H:i",$r->tgl).$cod;?></td>
            <td>
                <div class="m-b-6">
            ...
            <td>
                <a href="javascript:detail(<?=$r->id?>)" class="btn btn-sm btn-primary"><i class="fas fa-list"></i>
                    Detail</a>
            </td>
        </tr>
        <?php	
