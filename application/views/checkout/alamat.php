...
<form id="alamat">
    <div class="row">
                ...
                <div class="tambahalamat" style="display:none;">
                    <div class="m-b-12 col-md-10 p-lr-0">
                        <input class="form-control" type="text" name="judul"
                            placeholder="Simpan Sebagai? ex: Alamat Rumah, Alamat Kantor, Dll">
                    </div>
        ...
        <div class="col-md-4">
            <div class="section p-all-24">
                ...
                <div class="dropship">
                    <div class="m-t-10">
                        <button type="button" id="nodrop" class="btn btn-primary m-r-10"><i
                                class="fa fa-check-square"></i> Tidak Dropship</button>
                        <div class="showsmall m-t-10"></div>
                        <button type="button" id="yesdrop" class="btn btn-outline-primary"><i class="fa fa-check-square"
                                style="display:none"></i> Dropship</button>
                    </div>
    ...
    <div class="text-center p-t-32">
        <button type="submit" class="btn btn-lg btn-primary">SELANJUTNYA &nbsp;<i
    ...
    $("#alamat").on("submit", function(e) {
        ...
        $.post("<?=site_url("checkout/simpanalamat")?>", $(this).serialize(), function(msg) {
            ...
            if (data.success == true) {
                ...
                swal.fire("Gagal Menyimpan Alamat",
                    "terjadi kesalahan saat menyimpan alamat Anda. Silahkan ulangi beberapa saat lagi",
                    "warning");
            }
        });
    });
