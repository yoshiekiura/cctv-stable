	        ...
	        <div class="col-md-3 m-b-20">
	            ...
	            <div class="m-b-20">
	                <a target="_blank" onclick="fbq('track','Contact')"
	                    href="https://wa.me/<?=$this->func->getRandomWasap()?>/?text=Halo,%20mohon%20infonya%20untuk%20menjadi%20reseller%20*<?=$this->func->getSetting("nama")?>*%20caranya%20bagaimana%20ya?%20dan%20syaratnya%20apa%20saja,%20terima%20kasih"
	                    class="btn btn-success btn-block"><i class="fab fa-whatsapp"></i> Hubungi Admin</a>
...
$(function() {
	        ...
	        <div class="modal-content">
	            ...
	            <div class="modal-body pesan" id="pesan">
	                <div class="pesanwrap center">
	                    <div class="isipesan"><i class="fas fa-spin fa-compact-disc text-success"></i> memuat pesan...
	                    </div>
	                </div>
	            </div>
	            <form id="kirimpesan" method="POST">
	                <div class="modal-footer">
	                    <div class="input-group">
	                        <input type="text" class="form-control" placeholder="ketik pesan..." name="isipesan"
	                            required />
	...
	?>
	<div class="modal fade" id="modaldisclaimer" tabindex="-1" role="dialog" style="background: rgba(0,0,0,.5);"
	    style="bottom:0;right:0;" aria-hidden="true">
	    <div class="modal-dialog modal-dialog-centered" role="document">
	        <div class="modal-content">
	            <div class="modal-header">
	                <h5 class="modal-title text-danger font-medium"><i class="fa fa-exclamation-triangle"></i>
	                    &nbsp;Pemberitahuan Penting!</h5>
	                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
	                    <span aria-hidden="true">&times;</span>
	                </button>
	            </div>
...
$(function() {
    $(".countdown").each(function() {
        ...
        var x = setInterval(function() {
            ...
            if (days > 0) {
                var res = days + " <small>hari</small> " + hours + " : " + minutes + " : " +
                    seconds;
            } else {
